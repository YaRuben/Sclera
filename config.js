module.exports= {
    ...
    dblite: {
        ...
        usrinsert: `INSERT INTO users (user_status, user_role, user_login, user_pwd, user_time, user_created)
                    VALUES (1,?,?,?,?,?);`,
        // userSelect: `select * from users u join profiles p on p.user_id = u.user_id where u.user_status = ? and p.profile_status = 0`,
        userSelect: `select u.user_id Id, u.user_role Role,u.user_login Login,u.user_status Status,u.user_time,u.user_created,
        ...
        from users u join profiles p on p.user_id = u.user_id where u.user_status = ? and p.profile_status = 0`,
